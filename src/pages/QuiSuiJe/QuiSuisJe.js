...
export default function QuiSuisJe() {
  ...
  const updatePresentation = async () => {
    console.log(quiSuisJe._id, titleModify, resumeModify, descriptionModify)
    let data = {
      title: titleModify,
      resume: resumeModify,
    ...
    let reponse = await fetch(
      `http://127.0.0.1:8080/modifyPresentation/${quiSuisJe._id}/`,
      options
    );
  ...
  const updatePhoto = async () => {
    if (img.data) {
      ...
      const response = await fetch(
        `http://127.0.0.1:8080/createImagePresentation/${quiSuisJe._id}`,
        options
      );
    ...
    <div>
      ...
      <div className="prestationDetails">
        <div className="bigtitleDetails">
          ...
          {/* INPUT MODIF TITLE*/}
          <div className={hover()}>
            {edit === quiSuisJe.title && identifiant ? (
              <>
                <input
                  placeholder={quiSuisJe.title}
                  defaultValue={quiSuisJe.title}
          ...
          <div className={hover()}>
            {edit === quiSuisJe.resume && identifiant ? (
              <>
                <input
                  placeholder={quiSuisJe.resume}
                  defaultValue={quiSuisJe.resume}
                ...
                <div className="pictureDetails">
                  {identifiant ? (
                    <img
                      ...
                      src={`http://127.0.0.1:8080/presentation/${quiSuisJe.imgIllustration}`}
                      alt=""
                    />
                  ) : (
                    <img
